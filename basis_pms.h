...
class ISDist
{
  private:
	...
	int* last_run_best_soln;           // 上一轮的最佳解 alpha_lr*
    long long last_run_opt_unsat_weight; // 上一轮的最佳cost
    int last_run_feasible;             // 上一轮是否找到可行解
  ...
  public:
	ISDist();
	void settings(int seed, int allowed_time);
