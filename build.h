...
void ISDist::settings(int seed, int allowed_time)
{
    best_known = -2;
    local_soln_feasible = 1;

    cutoff_time = allowed_time;
    srand(seed);
    //cutoff_time = 300;
    max_tries = 100000000;
    max_flips = 200000000;
...
void ISDist::allocate_memory()
{
    ...
    last_run_best_soln = new int[malloc_var_length];
    last_run_opt_unsat_weight = __LONG_LONG_MAX__;
    last_run_feasible = 0;
}
